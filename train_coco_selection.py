...
from utils.training_utils4_search import visualize_sample, unpack_batch, visualize_sample2, visualize_sample3_img_coco
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for iter, batch in enumerate(pyprind.prog_bar(train_loader, title="[Epoch {}/{}]".format(epoch, args.epochs), width=50)):
            ...
            if (iter + 1) % args.visualize_every == 0:
                ...
                samples = visualize_sample3_img_coco(patch_discriminator, batch, vocab)
                patch_discriminator.train()
